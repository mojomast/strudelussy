  ...
  },
  {
    ...
    lessons: [
      lesson({
        ...
        instructions: 'Load the kick pattern, hit play, then make sure your code still uses s() with a sound name inside it. The editor now offers inline Strudel autocomplete while you type, and you can press Ctrl+Space to open the full list manually.',
        scaffold: 's("bd")',
        hints: [
          'Use the sample function with one drum name.',
          'Wrap the drum name in quotes inside s(...).',
          'Try `s("bd")`.',
          'Type `sou` to surface `sound`, or press Ctrl+Space on an empty line to browse suggestions.',
        ],
