...
const controls: FxControl[] = [
  ...
  { label: 'LP Filter', effect: 'lpf', min: 200, max: 20000, step: 50, defaultValue: 0 },
            ...
            {controls.map((control) => (
              <div key={control.effect} className="rounded-xl border border-zinc-800 bg-zinc-950/60 p-3">
                <div className="mb-3 flex items-center justify-between text-sm text-zinc-100">
                  ...
                  <span className="text-zinc-400">{values[control.effect]}</span>
                </div>
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                  ...
                  <Button
                    ...
                    onClick={() => onApplyCode(applyEffectToAllTracks(code, control.effect, values[control.effect]))}
                  >
                    Apply to All Tracks
                  </Button>
                </div>
