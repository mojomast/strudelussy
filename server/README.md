...
- The chat route allowlist currently only accepts `google/gemini-2.5-flash`, `google/gemini-3.1-flash-lite-preview`, `google/gemini-3-flash-preview`, and `openai/gpt-5.4-mini` from the UI.
