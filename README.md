...
- rhythm generator with per-voice gain, arrange mask, FX rack with explicit on/off filter states, mutate toolbar, keyboard shortcuts overlay, BPM tap tempo, and a visible restricted model selector
...
- chat model selection is restricted to `google/gemini-2.5-flash`, `google/gemini-3.1-flash-lite-preview`, `google/gemini-3-flash-preview`, and `openai/gpt-5.4-mini`
