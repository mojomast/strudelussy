...
- editor extension init now publishes a lightweight runtime status to `window.__strudelExtensions` so degraded autocomplete/hover startup is visible in production without reproducing the original failure locally
