...
- topbar actions for starting a blank project or reloading the demo template, compact prompt/model controls, an editable system prompt override, a global master volume control, GitHub links beside the project identity, and custom chat provider settings
