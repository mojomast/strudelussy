...
| **Runtime observability** | Editor extension startup publishes a lightweight status object to `window.__strudelExtensions` and logs warnings when autocomplete or hover initialization degrades |
